...
/*// This state is used to show the loading indicator when the phone number
 is being sent to the server for verification and the user is being redirected to the verification page. */
...
//This state is used to show the OTP widget in which the user enters the OTP sent to your phone number.
